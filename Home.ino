...
CommandErrors goHome(bool fast) {
  ...
  if (fast) {
    ...
    if (e == CE_NONE) {
      e=startGuideAxis2(a2,8,0,false,true);
      if (e == CE_NONE) VLF("MSG: Homing started phase 1"); else { stopGuideAxis1(); VLF("MSG: Homing failed"); }
    }
  } else {
    ...
    if (e == CE_NONE) {
      e=startGuideAxis2(a2,7,0,false,true);
      if (e == CE_NONE) VLF("MSG: Homing started phase 1"); else { stopGuideAxis1(); VLF("MSG: Homing failed"); }
    }
  }
