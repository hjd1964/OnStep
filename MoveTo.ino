...
void DecayModeTracking() {
  ...
  TMC2130_setup(true,false,AXIS1_MODE);  // 256x interpolation ON, stealthChop OFF (spreadCycle), micro-steps
  spiEnd();

  spiStart(Axis2_M2,Axis2_M1,Axis2_Aux,Axis2_M0);
  TMC2130_setup(true,false,AXIS2_MODE);
  spiEnd();
#endif
...
void DecayModeGoto() {
  ...
  //       CS      ,SCK     ,MISO     ,MOSI
  spiStart(Axis1_M2,Axis1_M1,Axis1_Aux,Axis1_M0);
  TMC2130_setup(true,false,AXIS1_MODE_GOTO);  // 256x interpolation ON, stealthChop OFF (spreadCycle), micro-steps
  spiEnd();

  spiStart(Axis2_M2,Axis2_M1,Axis2_Aux,Axis2_M0);
  TMC2130_setup(true,false,AXIS2_MODE_GOTO);
  spiEnd();
#endif
  #ifdef MODE_SWITCH_SLEEP_ON
  delay(3);
