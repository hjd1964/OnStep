...
// Stepper driver Fault detection on Aux1 and Aux2, choose only one feature to use on Aux1/2.  The SPI interface (on M0/M1/M2/Aux) returns status/error info. from TMC2130, TMC5160, etc.
