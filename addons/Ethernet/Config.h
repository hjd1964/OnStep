...
#define AXIS1_ENC_A_PIN 5          // specify pin#, for A or CW, default=5
#define AXIS1_ENC_B_PIN 6          // specify pin#, for B or CCW, default=6
...
#define AXIS2_ENC_A_PIN 7          // specify pin#, for A or CW, default=7
#define AXIS2_ENC_B_PIN 8          // specify pin#, for B or CCW, default=8
