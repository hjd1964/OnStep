...
#define AXIS1_ENC_OFF              // RA/Azm Axis on Pin 5 (A or CW) and Pin 6 (B or CCW), default = _OFF
...
#define AXIS2_ENC_OFF              // Dec/Alt Axis on Pin 7 (A or CW) and Pin 8 (B or CCW), default = _OFF
