...
#define L_WIRELESS_SIGNAL_STRENGTH "WiFi信号强度"
...
#define L_PEC_STATUS "PEC状态"
#define L_PEC_CONTROL "PEC控制"
...
#define L_PEC_EEWRITE_MESSAGE "将PEC数据写入EEPROM，以便在控制器重新启动时可以使用。写入数据可能需要几秒钟."
#define L_PEC_NO_PEC_MESSAGE "已停用PEC控制"
...
#define L_REFINE_MESSAGE2 "然后按[Refine PA]键。使用方向键将星星重新定位在目镜中."
...
#define L_WIFI_CONFIG_SECURITY "WiFi配置安全性"

#define L_WIFI_AP "访问点模式"

#define L_WIFI_RESTART_MSG "您必须手动<u>重新启动</ u>才能使更改生效."

#define L_WIFI_TITLE "输入密码以更改WiFi配置:"
...
#define L_DOWN_MESSAGE4B "配置错误的Teensy3.2或Arduino M0波特率."
#define L_DOWN_MESSAGE5 "配置错误的ESP8266 SERIAL_SWAP."
