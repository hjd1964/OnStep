...
// Initializes big 2,3" display from diymore.cc
  ...
  // Important: The display needs RESET connected to Pin14 for Teensy's
  class U8G2_EXT_SSD1309_128X64_NONAME_F_HW_I2C : public U8G2_EXT {
  public: U8G2_EXT_SSD1309_128X64_NONAME_F_HW_I2C(const u8g2_cb_t *rotation, uint8_t reset = 14, uint8_t clock = SCL, uint8_t data = SDA) : U8G2_EXT() { 
    u8g2_Setup_ssd1309_i2c_128x64_noname0_f(&u8g2, rotation, u8x8_byte_arduino_hw_i2c, u8x8_gpio_and_delay_arduino); 
    u8x8_SetPin_HW_I2C(getU8x8(), reset, clock, data);
  }
  };
#else
  // Important: The display needs RESET connected to Pin23 for ESP32's
  class U8G2_EXT_SSD1309_128X64_NONAME_F_HW_I2C : public U8G2_EXT {
  public: U8G2_EXT_SSD1309_128X64_NONAME_F_HW_I2C(const u8g2_cb_t *rotation, uint8_t reset = 23, uint8_t clock = SCL, uint8_t data = SDA) : U8G2_EXT() { 
    u8g2_Setup_ssd1309_i2c_128x64_noname0_f(&u8g2, rotation, u8x8_byte_arduino_hw_i2c, u8x8_gpio_and_delay_arduino); 
    u8x8_SetPin_HW_I2C(getU8x8(), reset, clock, data);
  }
  };
