...
#define AXIS1_LIMIT_MIN              -180 //   -180, n. Where n=-105..-180 (degrees.) Minimum "Hour Angle" for Eq modes.      Infreq
                                          //         n. Where n=-180..-360 (degrees.) Minimum Azimuth for AltAzm mode.        Infreq
#define AXIS1_LIMIT_MAX               180 //    180, n. Where n= 105.. 180 (degrees.) Maximum "Hour Angle" for Eq modes.      Infreq
                                          //         n. Where n= 180.. 360 (degrees.) Maximum Azimuth for AltAzm mode.        Infreq
