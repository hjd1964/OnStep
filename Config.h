...
// [S] for Sync (or Accept if in align mode.) [N] for Tracking on/off (or meridian flip continue if paused.)  -OR- Press and hold [N]+[S] buttons for > 2 seconds...  In this mode [E] selects prior and [W] next user catalog item.
