...
#define SERIAL_B_BAUD_DEFAULT      256000 //   9600, n. See (src/HAL/) for your MCU Serial port # etc.                        Option
...
// AXIS1 RA/AZM --------------------------
#define AXIS1_STEPS_PER_DEGREE  48713.142 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
#define AXIS1_STEPS_PER_WORMROT    121782 //  12800, n. Number of steps per worm rotation (PEC Eq mode only:)                <-Req'd
...
// AXIS2 DEC/ALT -------------------------
#define AXIS2_STEPS_PER_DEGREE  48713.142 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS4_STEPS_PER_MICRON      1.818 //    0.5, n. Steps per micro-meter. Figure this out by testing or other means.     Adjust
#define AXIS4_STEP_RATE_MAX           2.0 //    8.0, n, (milli-sec.) Min. ms/step depends on processor. In DC mode, PWM freq. Adjust
