...
#define ST4_HAND_CONTROL              OFF // Default    OFF,    Special features w/basic hand control combo button presses & smart hand control (SHC) support.    Optional, OFF allows only <= 1X rates on the ST4 port.
#define ST4_HAND_CONTROL_FOCUSER      OFF // Default    OFF,    Basic hand control combo button presses for focuser control instead of catalog gotos/sync/sound.  Optional.
