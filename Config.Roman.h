// -----------------------------------------------------------------------------------
// Configuration for OnStep legacy "Alternate pin-map" (Mega2560)
...
#define BacklashTakeupRate        25 // backlash takeup rate (in multipules of the sidereal rate): too fast and your motors will stall,
                                     ...
                                     // Axis1 is for RA/Az
#define StepsPerDegreeAxis1  15643.83333  // calculated as    :  stepper_steps * micro_steps * gear_reduction1 * (gear_reduction2/360)
                                     // NEMA17 + PLANET   :  200           * 16          * 3.71*55/16          *  138/360         = 15643,83333
