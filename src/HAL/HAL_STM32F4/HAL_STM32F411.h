...
#define a2CS_H WRITE_REG(Axis2_M2PORT->BSRRL, Axis2_M2BIT)
#define a2CS_L WRITE_REG(Axis2_M2PORT->BSRRH, Axis2_M2BIT)
#define a2CLK_H WRITE_REG(Axis2_M1PORT->BSRRL, Axis2_M1BIT)
#define a2CLK_L WRITE_REG(Axis2_M1PORT->BSRRH, Axis2_M1BIT)
#define a2SDO_H WRITE_REG(Axis2_M0PORT->BSRRL, Axis2_M0BIT)
#define a2SDO_L WRITE_REG(Axis2_M0PORT->BSRRH, Axis2_M0BIT)
