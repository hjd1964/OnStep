// A4988 stepper driver validate
    ...
    #error "Configuration: AXIS1_DRIVER_MICROSTEPS; A4988 invalid micro-step mode, use: 16,8,4,2,or 1"
  #endif
    ...
    #error "Configuration: AXIS2_DRIVER_MICROSTEPS; A4988 invalid micro-step mode, use: 16,8,4,2,or 1"
  #endif
  #if HAL_PULSE_WIDTH < A4988_PULSE_WIDTH
    #error "Configuration: STEP_WAVE_FORM PULSE; Pulse width is below the A4988 stepper driver specifications."
  #endif
      ...
      #error "Configuration: AXIS1_DRIVER_MICROSTEPS_GOTO; A4988 invalid micro-step mode, use: 16,8,4,2,1,or OFF"
    #endif
  #endif
#endif
      ...
      #error "Configuration: AXIS2_DRIVER_MICROSTEPS_GOTO; A4988 invalid micro-step mode, use: 16,8,4,2,1,or OFF"
    #endif
  #endif
#endif
