// S109 stepper driver validate
    ...
    #error "Configuration: AXIS1_DRIVER_MICROSTEPS; S109 invalid micro-step mode, use: 32,16,8,4,2,or 1"
  #endif
    ...
    #error "Configuration: AXIS2_DRIVER_MICROSTEPS; S109 invalid micro-step mode, use: 32,16,8,4,2,or 1"
  #endif
  #if HAL_PULSE_WIDTH < S109_PULSE_WIDTH
    #error "Configuration: STEP_WAVE_FORM PULSE; Pulse width is below the S109 stepper driver specifications."
  #endif
      ...
      #error "Configuration: AXIS1_DRIVER_MICROSTEPS_GOTO; S109 invalid micro-step mode, use: 32,16,8,4,2,1,or OFF"
    #endif
  #endif
#endif
#if AXIS2_DRIVER_MICROSTEPS_GOTO != OFF
      ...
      #error "Configuration: AXIS2_DRIVER_MICROSTEPS_GOTO; S109 invalid micro-step mode, use: 32,16,8,4,2,1,or OFF"
    #endif
  #endif
#endif
