// TMC2209 stepper driver validate
    ...
    #error "Configuration: AXIS2_DRIVER_MICROSTEPS; TMC2209 invalid micro-step mode, use: 64,32,16,or 8"
  #endif
  #if HAL_PULSE_WIDTH < TMC2209_PULSE_WIDTH
    #error "Configuration: STEP_WAVE_FORM PULSE; Pulse width is below the TMC2209 stepper driver specifications."
  #endif
      ...
      #error "Configuration: AXIS1_DRIVER_MICROSTEPS_GOTO; TMC2209 invalid micro-step mode, use: 64,32,16,8,or OFF"
    #endif
  #endif
#endif
      ...
      #error "Configuration: AXIS2_DRIVER_MICROSTEPS_GOTO; TMC2209 invalid micro-step mode, use: 64,32,16,8,or OFF"
    #endif
  #endif
#endif
