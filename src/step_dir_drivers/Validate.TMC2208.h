// TMC2208 stepper driver validate
    ...
    #error "Configuration: AXIS1_DRIVER_MICROSTEPS; TMC2208 invalid micro-step mode, use: 16,8,4,or 2"
  #endif
    ...
    #error "Configuration: AXIS2_DRIVER_MICROSTEPS; TMC2208 invalid micro-step mode, use: 16,8,4,or 2"
  #endif
  #if HAL_PULSE_WIDTH < TMC2208_PULSE_WIDTH
    #error "Configuration: STEP_WAVE_FORM PULSE; Pulse width is below the TMC2208 stepper driver specifications."
  #endif
      ...
      #error "Configuration: AXIS1_DRIVER_MICROSTEPS_GOTO; TMC2208 invalid micro-step mode, use: 16,8,4,2,or OFF"
    #endif
  #endif
#endif
      ...
      #error "Configuration: AXIS2_DRIVER_MICROSTEPS_GOTO; TMC2208 invalid micro-step mode, use: 16,8,4,2,or OFF"
    #endif
  #endif
#endif
