// SERVO driver validate
    ...
    #error "Configuration (Config.h): AXIS1_DRIVER_MICROSTEPS; SERVO invalid digital gearing mode, use: 128,64,32,16,8,4,2,or 1"
  #endif
    ...
    #error "Configuration (Config.h): AXIS2_DRIVER_MICROSTEPS; SERVO invalid digital gearing mode, use: 128,64,32,16,8,4,2,or 1"
  #endif
  #if HAL_PULSE_WIDTH < SERVO_PULSE_WIDTH
    #error "Configuration (Config.h): STEP_WAVE_FORM PULSE; Pulse width is below the SERVO generic driver settings."
  #endif
