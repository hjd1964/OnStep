// TMC_SPI stepper driver validate
    ...
    #error "Configuration: AXIS1_DRIVER_MICROSTEPS; TMC SPI stepper driver invalid micro-step mode, use: 256,128,64,32,16,8,4,2,or 1"
  #endif
    ...
    #error "Configuration: TMC SPI stepper drivers must be used in pairs (both Axis1 and Axis2.)"
      ...
      #error "Configuration: AXIS1_DRIVER_MICROSTEPS_GOTO; TMC SPI stepper driver invalid micro-step mode, use: 256,128,64,32,16,8,4,2,or 1"
    #endif
    #if AXIS1_DRIVER_MICROSTEPS != AXIS1_DRIVER_MICROSTEPS_GOTO
      #warning "Configuration: AXIS2_DRIVER_MICROSTEPS_GOTO; is not OFF.  This can effect pointing accuracy and PEC if index sensing isn't used."
    #endif
  #endif
    ...
    #error "Configuration: AXIS2_DRIVER_MICROSTEPS; TMC SPI stepper driver invalid micro-step mode, use: 256,128,64,32,16,8,4,2,or 1"
  #endif
  #if AXIS1_DRIVER_MODEL != TMC_SPI
    #error "Configuration: TMC SPI stepper drivers must be used in pairs (both Axis1 and Axis2.)"
  #endif
      ...
      #error "Configuration: AXIS2_DRIVER_MICROSTEPS_GOTO; TMC SPI stepper driver invalid micro-step mode, use: 256,128,64,32,16,8,4,2,or 1"
    #endif
    #if AXIS2_DRIVER_MICROSTEPS != AXIS2_DRIVER_MICROSTEPS_GOTO
      #warning "Configuration: AXIS2_DRIVER_MICROSTEPS_GOTO; is not OFF.  This can effect pointing accuracy."
    #endif
  #endif
  #if HAL_PULSE_WIDTH < TMC_SPI_PULSE_WIDTH
    #error "Configuration: STEP_WAVE_FORM PULSE; Pulse width is below the TMC SPI stepper driver specifications."
    ...
    #error "Configuration: AXIS3_DRIVER_MICROSTEPS; TMC SPI stepper driver invalid micro-step mode, use: 256,128,64,32,16,8,4,2,or 1"
  #endif
#endif
    ...
    #error "Configuration: AXIS4_DRIVER_MICROSTEPS; TMC SPI stepper driver invalid micro-step mode, use: 256,128,64,32,16,8,4,2,or 1"
  #endif
#endif
    ...
    #error "Configuration: AXIS5_DRIVER_MICROSTEPS; TMC SPI stepper driver invalid micro-step mode, use: 256,128,64,32,16,8,4,2,or 1"
  #endif
#endif
