...
#elif (AXIS1_DRIVER_MODEL == TMC5160_LOWPWR) || (AXIS1_DRIVER_MODEL == TMC5160_QUIET_LOWPWR) || (AXIS1_DRIVER_MODEL == TMC5160_VQUIET_LOWPWR)
  #error "Configuration: AXIS1 _LOWPWR option isn't supported for TMC5160 stepper drivers, use AXISn_TMC_IRUN and _IGOTO to set the pwr levels."
#endif
...
#elif (AXIS2_DRIVER_MODEL == TMC5160_LOWPWR) || (AXIS2_DRIVER_MODEL == TMC5160_QUIET_LOWPWR) || (AXIS2_DRIVER_MODEL == TMC5160_VQUIET_LOWPWR)
  #error "Configuration: AXIS2 _LOWPWR option isn't supported for TMC5160 stepper drivers, use AXISn_TMC_IRUN and _IGOTO to set the pwr levels."
#endif
