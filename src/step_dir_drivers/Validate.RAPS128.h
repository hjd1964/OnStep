// RAPS128 stepper driver validate
    ...
    #error "Configuration: AXIS1_DRIVER_MICROSTEPS; RAPS128 invalid micro-step mode, use: 128,64,32,16,8,4,2,or 1"
  #endif
    ...
    #error "Configuration: AXIS2_DRIVER_MICROSTEPS; RAPS128 invalid micro-step mode, use: 128,64,32,16,8,4,2,or 1"
  #endif
  #if HAL_PULSE_WIDTH < RAPS128_PULSE_WIDTH
    #error "Configuration: STEP_WAVE_FORM PULSE; Pulse width is below the RAPS128 stepper driver specifications."
  #endif
      ...
      #error "Configuration: AXIS1_DRIVER_MICROSTEPS_GOTO; RAPS128 invalid micro-step mode, use: 128,64,32,16,8,4,2,1,or OFF"
    #endif
  #endif
#endif
      ...
      #error "Configuration: AXIS2_DRIVER_MICROSTEPS_GOTO; RAPS128 invalid micro-step mode, use: 128,64,32,16,8,4,2,1,or OFF"
    #endif
  #endif
#endif
