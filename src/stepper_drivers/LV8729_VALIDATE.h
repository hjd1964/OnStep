// LV8729 stepper driver validate
    ...
    #error "Configuration: STEP_WAVE_FORM PULSE; Pulse width is below the LV8729 stepper driver specifications."
      ...
      #error "Configuration: AXIS1_MICROSTEPS_GOTO; LV8729 invalid micro-step mode, use: 128,64,32,16,8,4,2,1,or _OFF"
    #endif
  #endif
#endif
      ...
      #error "Configuration: AXIS2_MICROSTEPS_GOTO; LV8729 invalid micro-step mode, use: 128,64,32,16,8,4,2,1,or _OFF"
    #endif
  #endif
#endif
