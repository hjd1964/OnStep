...
#elif FEATURE1_TEMP != OFF && (FEATURE1_TEMP & DS_MASK) != DS18S20 && (FEATURE1_TEMP & DS_MASK) != DS18B20
...
#elif FEATURE2_TEMP != OFF && (FEATURE2_TEMP & DS_MASK) != DS18S20 && (FEATURE2_TEMP & DS_MASK) != DS18B20
...
#elif FEATURE3_TEMP != OFF && (FEATURE3_TEMP & DS_MASK) != DS18S20 && (FEATURE3_TEMP & DS_MASK) != DS18B20
...
#elif FEATURE4_TEMP != OFF && (FEATURE4_TEMP & DS_MASK) != DS18S20 && (FEATURE4_TEMP & DS_MASK) != DS18B20
...
#elif FEATURE5_TEMP != OFF && (FEATURE5_TEMP & DS_MASK) != DS18S20 && (FEATURE5_TEMP & DS_MASK) != DS18B20
...
#elif FEATURE6_TEMP != OFF && (FEATURE6_TEMP & DS_MASK) != DS18S20 && (FEATURE6_TEMP & DS_MASK) != DS18B20
...
#elif FEATURE7_TEMP != OFF && (FEATURE7_TEMP & DS_MASK) != DS18S20 && (FEATURE7_TEMP & DS_MASK) != DS18B20
...
#elif FEATURE8_TEMP != OFF && (FEATURE8_TEMP & DS_MASK) != DS18S20 && (FEATURE8_TEMP & DS_MASK) != DS18B20
...
#if (FEATURE1_TEMP & DS_MASK) == DS18B20 || (FEATURE2_TEMP & DS_MASK) == DS18B20 || (FEATURE3_TEMP & DS_MASK) == DS18B20 || (FEATURE4_TEMP & DS_MASK) == DS18B20 || (FEATURE5_TEMP & DS_MASK) == DS18B20 || (FEATURE6_TEMP & DS_MASK) == DS18B20 || (FEATURE7_TEMP & DS_MASK) == DS18B20 || (FEATURE8_TEMP & DS_MASK) == DS18B20 
  #define DS1820_DEVICES_PRESENT
#endif
...
#if !defined(DS1820_DEVICES_PRESENT) && (TELESCOPE_TEMPERATURE & DS_MASK) == DS18B20
  #define DS1820_DEVICES_PRESENT
#endif
