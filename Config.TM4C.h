...
#define AXIS1_DRIVER_MODEL_OFF      // Default _OFF, use A4988, DRV8825, LV8729, RAPS128, TMC2130, TMC2208
#define AXIS1_MICROSTEPS_OFF        // Axis1 (RA/Alt): Default _OFF, Microstep mode when the scope is doing sidereal tracking
