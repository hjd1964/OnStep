  ...
  if (trackingState!=TrackingMoveTo) {
    ...
    if (guideDirAxis1) {
      if ((fabs(guideTimerRateAxis1)<10.0) && (fabs(guideTimerRateAxis1A)<10.0)) { 
        ...
        // use acceleration
        StepperModeGoto();
        if (guideTimerRateAxis1A>guideTimerRateAxis1) { guideTimerRateAxis1A-=(acc/100.0); if (guideTimerRateAxis1A<guideTimerRateAxis1) guideTimerRateAxis1A=guideTimerRateAxis1; }
        if (guideTimerRateAxis1A<guideTimerRateAxis1) { guideTimerRateAxis1A+=(acc/100.0); if (guideTimerRateAxis1A>guideTimerRateAxis1) guideTimerRateAxis1A=guideTimerRateAxis1; }
        // stop guiding
        if (guideDirAxis1=='b') {
          if (abs(guideTimerRateAxis1A)<0.001) { guideDirAxis1=0; guideTimerRateAxis1=0.0; guideTimerRateAxis1A=0.0; if (!guideDirAxis2) StepperModeTracking(); } else guideTimerRateAxis1=0.0;
        }
      }
    ...
    if (guideDirAxis2) {
      if ((fabs(guideTimerRateAxis2)<10.0) && (fabs(guideTimerRateAxis2A)<10.0)) { 
        ...
        // use acceleration
        StepperModeGoto();
        if (guideTimerRateAxis2A>guideTimerRateAxis2) { guideTimerRateAxis2A-=(acc/100.0); if (guideTimerRateAxis2A<guideTimerRateAxis2) guideTimerRateAxis2A=guideTimerRateAxis2; }
        if (guideTimerRateAxis2A<guideTimerRateAxis2) { guideTimerRateAxis2A+=(acc/100.0); if (guideTimerRateAxis2A>guideTimerRateAxis2) guideTimerRateAxis2A=guideTimerRateAxis2; }
        // stop guiding
        if (guideDirAxis2=='b') {
          if (abs(guideTimerRateAxis2A)<0.001) { guideDirAxis2=0; guideTimerRateAxis2=0.0; guideTimerRateAxis2A=0.0; if (!guideDirAxis1) StepperModeTracking(); } else guideTimerRateAxis2=0.0;
        }
      }
